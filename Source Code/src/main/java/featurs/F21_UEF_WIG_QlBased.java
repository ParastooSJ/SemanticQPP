 ...
 * @author Parastoo
 */
public class F21_UEF_WIG_QlBased extends WordBasedFeature{
    
    public F21_UEF_WIG_QlBased(String dataset, String rs, int docCount, int start, int end, String feature) {
    ...
    public double CalculateSimilarityScore(String queryId){
        double score = 0;
            try {
                String clarityPath ="./crossfold/"+dataset+"/result/"+this.rs+"-"+dataset+"-"+this.docCount+"docs-percentEntities-F05.txt";
