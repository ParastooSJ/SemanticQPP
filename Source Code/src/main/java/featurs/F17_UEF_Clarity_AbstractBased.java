 ...
 * @author Parastoo
 */
public class F17_UEF_Clarity_AbstractBased extends WordBasedFeature{
    
    public F17_UEF_Clarity_AbstractBased(String dataset, String rs, int docCount, int start, int end, String feature) {
    ...
    public double CalculateSimilarityScore(String queryId){
        double score = 0;
            try {
                String clarityPath ="./crossfold/"+dataset+"/result/"+this.rs+"-"+dataset+"-"+this.docCount+"docs-percentEntities-F11.txt";
