 ...
 * @author Parastoo
 */
public class F16_UEF_AvgScore_CosineBased extends WordBasedFeature{
    
    public F16_UEF_AvgScore_CosineBased(String dataset, String rs, int docCount, int start, int end, String feature) {
    ...
    public double CalculateSimilarityScore(String queryId){
        double score = 0;
            try {
                String clarityPath ="./crossfold/"+dataset+"/result/"+this.rs+"-"+dataset+"-"+this.docCount+"docs-percentEntities-F06.txt";
