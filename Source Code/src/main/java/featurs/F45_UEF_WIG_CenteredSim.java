 ...
 * @author parastoo
 */
public class F45_UEF_WIG_CenteredSim extends WordBasedFeature {
    public F45_UEF_WIG_CenteredSim(String dataset, String rs, int docCount, int start, int end, String feature) {
    ...
    public double CalculateSimilarityScore(String queryId){
        double score = 0;
            try {
                String clarityPath ="./crossfold/"+dataset+"/result/"+this.rs+"-"+dataset+"-"+this.docCount+"docs-percentEntities-F42.txt";
