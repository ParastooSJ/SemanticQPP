 ...
 * @author parastoo
 */
public class F39_Inner_TFIDF extends EntityBasedFeature {
     public F39_Inner_TFIDF(String dataset, String rs, int docCount, int start, int end, String feature) {
        ...
        try {
            ...
            for (int i = 0; i < docsTitle.size(); i++) {
                for (int j = i+1; j < docsTitle.size(); j++) {
                    ...
                    double cosineSimilarity = calculateTFIDF(document1, document2, docsTitle.get(j));
