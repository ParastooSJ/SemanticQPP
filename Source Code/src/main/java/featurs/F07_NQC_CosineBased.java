 ...
 * @author parastoo
 */
public class F07_NQC_CosineBased extends EntityBasedFeature{
    
    public F07_NQC_CosineBased(String dataset, String rs, int docCount, int start, int end, String feature) {
