 ...
 * @author parastoo
 */
public class F37_UEF_NQC_TFIDF extends WordBasedFeature {
    public F37_UEF_NQC_TFIDF(String dataset, String rs, int docCount, int start, int end, String feature) {
    ...
    public double CalculateSimilarityScore(String queryId){
        double score = 0;
            try {
                String clarityPath ="./crossfold/"+dataset+"/result/"+this.rs+"-"+dataset+"-"+this.docCount+"docs-percentEntities-F25.txt";
