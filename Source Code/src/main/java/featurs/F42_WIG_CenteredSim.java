 ...
 * @author parastoo
 */
public class F42_WIG_CenteredSim extends EntityBasedFeature{
    public F42_WIG_CenteredSim(String dataset, String rs, int docCount, int start, int end, String feature) {
