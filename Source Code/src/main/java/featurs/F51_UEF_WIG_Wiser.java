 ...
 * @author parastoo
 */
public class F51_UEF_WIG_Wiser extends WordBasedFeature{
    public F51_UEF_WIG_Wiser(String dataset, String rs, int docCount, int start, int end, String feature) {
    ...
    public double CalculateSimilarityScore(String queryId){
        double score = 0;
            try {
                String clarityPath ="./crossfold/"+dataset+"/result/"+this.rs+"-"+dataset+"-"+this.docCount+"docs-percentEntities-F48.txt";
