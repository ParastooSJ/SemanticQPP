 ...
 * @author parastoo
 */
public class F41_NQC_CenteredSim extends EntityBasedFeature{
    public F41_NQC_CenteredSim(String dataset, String rs, int docCount, int start, int end, String feature) {
