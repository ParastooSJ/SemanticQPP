 ...
 * @author parastoo
 */
public class F54_query_document_CenteredSimilarity extends EntityBasedFeature{
     public F54_query_document_CenteredSimilarity(String dataset, String rs, int docCount, int start, int end, String feature) {
    ...
    protected double CalculateSimilarityScore(String queryId) {
        ...
        try {
            ...
            for (int i = 0; i < docsTitle.size(); i++) {
                ...
                double p_q_d = calculateCenteredSimilarity(query,"query",docsTitle.get(i));
            ...
            double p_q_C = calculateCenteredSimilarity(query,"query", "Collection");
