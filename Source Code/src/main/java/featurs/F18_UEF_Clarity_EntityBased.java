 ...
 * @author Parastoo
 */
public class F18_UEF_Clarity_EntityBased extends WordBasedFeature{
    
    public F18_UEF_Clarity_EntityBased(String dataset, String rs, int docCount, int start, int end, String feature) {
    ...
    public double CalculateSimilarityScore(String queryId){
        double score = 0;
            try {
                String clarityPath ="./crossfold/"+dataset+"/result/"+this.rs+"-"+dataset+"-"+this.docCount+"docs-percentEntities-F03.txt";
