 ...
 * @author parastoo
 */
public class F30_UEF_WIG_Abstractbased extends WordBasedFeature {
    public F30_UEF_WIG_Abstractbased(String dataset, String rs, int docCount, int start, int end, String feature) {
    ...
    public double CalculateSimilarityScore(String queryId){
        double score = 0;
            try {
                String clarityPath ="./crossfold/"+dataset+"/result/"+this.rs+"-"+dataset+"-"+this.docCount+"docs-percentEntities-F27.txt";
