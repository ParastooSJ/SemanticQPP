 ...
 * @author Parastoo
 */
public class F19_UEF_InnerSim_CosineBased extends WordBasedFeature {
    
    public F19_UEF_InnerSim_CosineBased(String dataset, String rs, int docCount, int start, int end, String feature) {
