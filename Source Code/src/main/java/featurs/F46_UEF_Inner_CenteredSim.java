 ...
 * @author parastoo
 */
public class F46_UEF_Inner_CenteredSim extends WordBasedFeature {
    public F46_UEF_Inner_CenteredSim(String dataset, String rs, int docCount, int start, int end, String feature) {
    ...
    public double CalculateSimilarityScore(String queryId){
        double score = 0;
            try {
                String clarityPath ="./crossfold/"+dataset+"/result/"+this.rs+"-"+dataset+"-"+this.docCount+"docs-percentEntities-F43.txt";
