 ...
 * @author parastoo
 */
public class F26_NQC_Abstractbased extends WordBasedFeature{
    public F26_NQC_Abstractbased(String dataset, String rs, int docCount, int start, int end, String feature) {
