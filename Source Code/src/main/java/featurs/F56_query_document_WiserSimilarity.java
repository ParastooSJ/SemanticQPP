 ...
 * @author parastoo
 */
public class F56_query_document_WiserSimilarity extends EntityBasedFeature {
     public F56_query_document_WiserSimilarity(String dataset, String rs, int docCount, int start, int end, String feature) {
