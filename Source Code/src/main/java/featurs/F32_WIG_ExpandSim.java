 ...
 * @author parastoo
 */
public class F32_WIG_ExpandSim extends EntityBasedFeature{
    
    public F32_WIG_ExpandSim(String dataset, String rs, int docCount, int start, int end, String feature) {
