 ...
 * @author parastoo
 */
public class F55_query_document_ExpandSimilarity extends EntityBasedFeature {
    public F55_query_document_ExpandSimilarity(String dataset, String rs, int docCount, int start, int end, String feature) {
