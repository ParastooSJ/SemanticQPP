 ...
 * @author parastoo
 */
public class F34_UEF_NQC_ExpandSim extends WordBasedFeature {
    public F34_UEF_NQC_ExpandSim(String dataset, String rs, int docCount, int start, int end, String feature) {
    ...
    public double CalculateSimilarityScore(String queryId){
        double score = 0;
            try {
                String clarityPath ="./crossfold/"+dataset+"/result/"+this.rs+"-"+dataset+"-"+this.docCount+"docs-percentEntities-F31.txt";
